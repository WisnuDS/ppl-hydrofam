...
@section('content')
    @include('components.jumbotron',["title" => "Edit Product"])
    <section class="ftco-section">
        <div class="container">
            @if(auth()->user()->isA('admin'))
                <form action="{{route('admin.shop.update',["shop" => $item->id])}}" method="POST" class="billing-form" id="product_form" enctype="multipart/form-data">
                    @elseif(auth()->user()->isA('super'))
                        <form action="{{route('super.shop.update',["shop" => $item->id])}}" method="POST" class="billing-form" id="product_form" enctype="multipart/form-data">
                            @endif
                            @method('PUT')
                            @csrf
                                        ...
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" placeholder="" id="product_name"
                                                       name="product_name" value="{{$item->item_name}}">
                                            </div>
                                        </div>
                                        <div class="w-100"></div>
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" placeholder="" id="product_price"
                                                       name="product_price" value="{{$item->price}}">
                                            </div>
                                        </div>
                                        <div class="w-100"></div>
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" placeholder="" id="product_stock" name="product_stock" value="{{$item->unit}}">
                                            </div>
                                        </div>
                                        <div class="w-100"></div>
                                        <div class="col-md-12">
